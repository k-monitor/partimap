...
export default {
	...
	landing: {
		...
		features: [
			...
			},
			{
				...
				description:
					'<p>Ein statisches Karten-Arbeitsblatt kann in den Fragebogen eingefügt werden, um ein bestimmtes Verkehrs-, Infrastruktur- oder Entwicklungs­konzept auf der Karte darzustellen und Feedback dazu zu sammeln. Elemente aus anderen Kartendiensten (z. B. Google Maps) lassen sich importieren und in PARTIMAP visualisieren und auswerten. Das karten-basierte Arbeitsblatt kann zudem dieselben Fragetypen wie der Fragebogen enthalten sowie ergänzende Erklärungen, Beschreibungen und Links. Die bearbeitete Karte lässt sich speichern und für zukünftige Projekte wiederverwenden.</p><p>Die statische Karte ist ein ideales Werkzeug, um Anwohner zu bitten, verschiedene Infrastrukturen innerhalb einer Kommune zu bewerten – etwa generelle Zugänglichkeit, Barrierefreiheit oder Fahrradfreundlichkeit. Nach Auswertung lassen sich komplexe Analysen erstellen. Dieses Arbeitsblatt eignet sich auch dafür, konkrete Entwicklungs­entscheidungen zu treffen, indem etwa Version A und B eines Planungsvorschlags verglichen und von den Teilnehmenden favorisiert werden.</p>',
			},
			{
				title: 'Jetzt sind Sie dran – tragen Sie sich auf der Karte ein!',
				description:
					'<p>Das Besondere an PARTIMAP gegenüber anderen Online-Umfrage­tools ist, dass Teilnehmende ihre Meinung mit Standortangabe äußern, Vorschläge grafisch darstellen oder zum Beispiel ihre täglichen Wege teilen können. Öffentliche Räume in Kommune, Stadtteil oder Nachbarschaft werden von verschiedenen Menschen genutzt. Ihre unterschiedlichen Bedürfnisse und Meinungen lassen sich mit dem interaktiven Karten-Arbeitsblatt erfassen. Teilnehmende können Punkte, Linien und Polygone nutzen, um grafische Antworten zu geben. Die eingehenden Beiträge lassen sich als Heatmap aufbereiten oder in einer anschließenden statischen Karte per Voting auswerten.</p>',
			},
			{
				title: 'Interoperabilität mit anderen Plattformen',
				description:
					'<p>Beide Karten-Arbeitsblätter verwenden openstreetmap.org als Hintergrundkarte, aus der eine eigene Basiskarte mit Fokusbereichen erstellt werden kann. In früheren Projekten gezeichnete Elemente lassen sich in der eigenen Kartenbibliothek speichern. Pro Arbeitsblatt kann die Basiskarte nicht nur aus diesem Repository, sondern auch als externe .KML-Datei importiert werden: Eine Import/Export-Funktion ermöglicht den schnellen Austausch mit Kartensoftware wie Google MyMaps oder komplexeren GIS-Anwendungen.</p><p>Die einfache Bearbeitungsoberfläche erlaubt das Zeichnen farbiger Punkte, Linien und Polygone. Mit einem Klick kann aus Nutzereingaben eine Basiskarte erstellt und als .KML exportiert werden – so sind die Daten in anderen Karten-Editoren nutzbar. Zukünftig planen wir weitere Raster-Basiskarten und neue grafische Darstellungen für gezeichnete Elemente (z. B. eigene Icons).</p>',
			},
			{
	...
	projectEditor: {
		...
		changeSuccessful: 'Projekt erfolgreich bearbeitet',
		copiedURL: 'Projekt-URL in die Zwischenablage kopiert!',
		embed: 'Einbetten',
		...
		generateSlug: 'Automatisch aus Projekttitel erzeugen!',
		language: 'Sprache der Umfrageoberfläche',
		newPassword: 'Neues Passwort',
		password: 'Passwortgeschützter Zugriff',
		passwordDescription:
			'Wenn Sie angemeldet sind, werden Ihre eigenen Projekte nicht nach einem Passwort fragen. Testen Sie im Inkognito- oder Privatmodus.',
	...
	projects: {
		add: 'Hinzufügen',
		creationFailed: 'Erstellen des Projekts fehlgeschlagen',
		deletionFailed: 'Löschen des Projekts fehlgeschlagen',
		...
		ownProjects: 'Eigene Projekte filtern',
	...
	sheet: {
		...
		restrictedTitle: 'Passwortgeschütztes Projekt',
	...
	unsubscribe: {
		...
		failed: 'Abmeldung fehlgeschlagen. Bitte melden Sie sich an und deaktivieren Sie die E-Mail-Benachrichtigungen in den Projekteinstellungen.',
		success:
			'Sie haben die E-Mail-Benachrichtigungen für dieses Projekt erfolgreich abbestellt.',
		title: 'Abbestellen',
	},
	userEditor: {
		activated: 'Aktiviert',
		...
		deleteConfirmation:
			'<strong>Sie sind dabei, Ihr Konto endgültig zu löschen. Sind Sie sicher?</strong> Ich bin sicher, löschen Sie mein Konto <strong>{email}</strong> mit allen Daten (Fotos, Karten, Projekte). Dieser Schritt ist unwiderruflich.',
		...
		logoDescription: 'Dieses Logo wird in allen Ihren Projekten im Header angezeigt.',
		name: 'Name',
		newPassword: 'Neues Passwort',
	...
	ProjectTransferModal: {
		confirm: 'Ich bin sicher, dass ich das Projekt übertragen möchte',
		email: 'Registrierte E-Mail des anderen Benutzer',
		failure: 'Projektübertragung fehlgeschlagen',
		ok: 'Übertragen',
		success: 'Projekt erfolgreich übertragen',
	},
