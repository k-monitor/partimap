...
export default {
	...
	login: {
		...
		email: 'Email',
		emailSent: 'Verification email sent to your address',
	...
	projectEditor: {
		...
		passwordDescription: 'If you are logged in, your own projects will not ask for a password. Test in incognito or private mode.',
		passwordSet: 'Password restriction set',
		privacyPolicy: 'Name and contact of the data controller',
		privacyPolicyDescription: 'This will be displayed as contact information in the Privacy Notice. Visitors will be requested to acknowledge and accept this before submitting a response.',
		...
		thanksUrlDescription: 'If set, a Learn more button appears below Acknowledgements, that leads to the web address linked here.',
	...
	userEditor: {
		...
		deleteConfirmation: '<strong>You are about to permanently delete your account. Are you sure?</strong> I\'m sure, delete my account <strong>{email}</strong> with all its data (photos, maps, projects). This action is permanent and irreversible.',
	...
	MapHint: {
		...
		LineString: 'Click starting point, optionally click more points. Double-click last point to end and save.',
	...
	SurveyEditor: {
		...
		required: 'Set as required question',
		showOnlyStatsToVisitors: 'Display only the results',
		showStatsToVisitors: 'Display results to visitors after submitting the sheet',
	},
	SurveyResult: {
