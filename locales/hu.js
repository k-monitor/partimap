export default {
	...
	CheckboxGroup: {
		a: 'Kérjük, jelölje be valamelyik jelölőnégyzetet!',
		valid2: 'Kérjük, jelölje be valamelyik jelölőnégyzetet!',
		other: 'Egyéb...',
	},
	DropdownGroup: {
		other: 'Egyéb...',
	...
	FeatureList: {
		...
		search: 'Keresés...',
		ownElements: 'Saját elemeid',
		fixElements: 'Fix Elemek'
	},
	FeatureListElement: {
	...
	ProjectSheetManager: {
		...
		title: 'Új munkalap',
		cancel: 'Mégsem',
		sheetLabelName: 'Munkalap elnevezése',
		nameRequired: 'Név megadása kötelező',
		noCopy: 'Nincs másolás',
		tooltipText: 'Szöveg',
		tooltipSurvey: 'Kérdőív',
		tooltipMap: 'Térkép',
		tooltipInteractiveMap: 'Interaktív térkép',
	},
	SheetContent: {
	...
	SurveyResult: {
		...
		numberOfRespondents: 'Válaszadók száma',
	},
	Sidebar: {
