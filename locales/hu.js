export default {
	...
	mapEditor: {
		...
		error: 'A módosítások mentése sikertelen.',
		name: 'Térkép neve',
	...
	projects: {
		add: 'Hozzáadás',
		creationFailed: 'Létrehozás sikertelen',
		deletionFailed: 'Sikertelen törlés.',
