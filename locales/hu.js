export default {
	...
	CheckboxGroup: {
		valid: 'Kérjük, jelölje be valamelyik jelölőnégyzetet!',
		other: 'Egyéb...',
	},
	DropdownGroup: {
		other: 'Egyéb...',
	...
	login: {
		login: 'Partimap Bejelentkezés',
		email: 'Email cím',
		password: 'Jelszó',
		forgotPassword: 'Elfelejtettem a jelszavam',
		dontHaveAccount: 'Még nincs fiókom',
		checkIn: 'Bejelentkezés',
		sendEmail: 'Aktivációhoz szükséges email kiküldve!',
		pwchanged: 'Jelszó sikeresen cserélve!',
		pwchangefailed: 'Jelszócsere sikertelen, próbáld újra!',
		lgn: 'Bejelentkezés',
		successActive: 'Sikeres aktiválás, most már bejelentkezhetsz!',
		errorActive: 'Sikertelen aktiválás, próbálj újra regisztrálni!',
		changePassword: 'Jelszócseréhez szükséges email kiküldve',
		badEmail: 'Érvénytelen email cím',
		badEmailOrPass: 'Érvénytelen email vagy jelszó',
	},
	landing: {
	...
	map: {
		backToMap: 'Vissza a térképekhez',
		mapName: 'Térkép neve',
		success: 'A módosítások mentése sikeres.',
		errorToast: 'A módosítások mentése sikertelen.',
	},
	maps: {
		maps: 'Térképek',
	...
	passwordChange: {
		passwordChange: 'Partimap Jelszócsere',
		newPassword: 'Új jelszó',
		save: 'Mentés',
		changePassOnHead: 'Jelszócsere',
	},
	PublicFrame: {
		help: 'Hogyan működik?',
		login: 'Belépés',
	...
	Projects: {
		...
		view: 'megtekintés',
		fill: 'kitöltés',
		riportsDownload: 'Riport letöltése',
		adminProjects: 'Admin: Projektek',
		name: 'Név',
		creationFailed: 'Létrehozás sikertelen',
		deleteFailed: 'Sikertelen törlés.',
	},
	register: {
		register: 'Partimap Regisztráció',
		email: 'Email cím',
		name: 'Név',
		password: 'Jelszó',
		readAndAccept: 'Elolvastam és elfogadom a',
		...
		haveRegistration: 'Regisztráció',
		failRegistration: 'Regisztráció sikertelen',
	},
	SheetContent: {
	...
	sheet: {
		privacyStatement: 'Felhasználási feltételek és adatvédelmi nyilatkozat',
		closedSurvey: 'Ez a kérdőív jelenleg le van zárva.',
		passwordRequired: 'Kérlek írd be a jelszót a megtekintéshez!',
		password: 'Jelszó',
		view: 'Megtekintés',
		passwordProtected: 'Jelszóval védett projekt',
		errorPassword: 'Érvénytelen jelszó!',
		submitSuccess: 'Beküldés sikeres.',
		submitError: 'Beküldés sikertelen.',
	},
	sheetEditor: {
		backProject: 'Vissza a projekthez',
		sheetName: 'Munkalap címe',
		sheetDescription: 'Munkalap leírása',
		fileSize: 'Maximális fájlméret: 5 MB',
		background: 'Háttérkép',
		dragAndDrop: 'Húzd ide a fájlt!',
		pictureBrowse: 'Kép tallózása...',
		deletePicture: 'Kép törlése',
		survey: 'Kérdőív',
		visitorInteractions: 'Látogatói interakciók',
		drawPoint: 'Instrukció pont felrajzolásához:',
		drawLine: 'Instrukció vonal felrajzolásához:',
		drawArea: 'Instrukció terület felrajzolásához:',
		NumberOfStars: 'Csillagok száma:',
		drawQuestion: 'Felrajzolt elemekhez rendelt kérdés',
		drawWhy: 'Miért rajzoltad ezt fel?',
		...
		errorToast: 'Módosítás sikertelen.',
		errorToastPicture: 'Kép feltöltése sikertelen.',
	},
	sheetCreat: {
		projects: 'Projektek',
		view: 'Megtekintés',
		projectName: 'Projekt címe',
		path: 'Elérési útvonal',
		changeRoute: 'Mentéskor a rendszer módosíthatja a fent beírt értéket, ha már van ilyen útvonal.',
		projectTitle: 'Generálás projekt címéből',
		...
		newPassword: 'Új jelszó',
		facebookPreviewText: 'Meta leírás (Facebook előnézeti szöveg)',
		maxFileSize: 'Maximális fájlméret: 5 MB',
		thumbnail: 'Facebook bélyegkép (ajánlott méret: 1200x630 pixel)',
		dragAndDrop: 'Húzd ide a fájlt!',
		browsePicture: 'Kép tallózása...',
		altThumbnail: 'Facebook bélyegkép',
		deletePicture: 'Kép törlése',
		dataController: 'Adatkezelő elérhetősége',
		privacyPolicy: 'Az Adatkezelési tájékoztatóban jelenik meg kapcsolatfelvételi adatként. Ezt a látogatóknak az 1. munkalapon kell majd elfogadniuk.',
		privacyPolicyRequired: 'Kötelező megadni!',
		acknowledgment: 'Köszönetnyilvánítás',
		onLastSheetForVisitors: 'A látogatóknak az utolsó munkalapon fog megjelenni, beküldés után.',
		nextURL: 'Tovább URL',
		nextURLlink: 'A köszönetnyilvánítás alatt megjelenő Tovább gomb erre fog linkelni.',
		share: 'Megosztás gombok a köszönetnyilvánítás alatt.',
		save: 'Mentés',
		changeSuccessful: 'Módosítás sikeres.',
		changeFailed: 'Módosítás sikertelen.',
		uploadPictureFailed: 'Kép feltöltése sikertelen.',
		errorAddSheet: 'Munkalap hozzáadása sikertelen.',
		errorDeleteSheet: 'Munkalap törlése sikertelen.',
		errorMoveSheet: 'Munkalap mozgatása sikertelen.',
	},
	user: {
		users: 'Felhasználók',
		name: 'Név',
		...
		logoAllProject: 'Ez a logó minden projektedben meg fog jelenni.',
		dragAndDrop: 'Húzd ide a fájlt!',
		browsePicture: 'Kép tallózása...',
		altLogo: 'Logó',
		deletePicture: 'Kép törlése',
		WebURL: 'Weboldal URL',
		uploadPicture: 'Ha feltöltesz logót, ide fog linkelni.',
		newPassword: 'Új jelszó',
		currentPassword: 'Jelenlegi jelszó (csak email vagy jelszó változtatás esetén szükséges)',
		activated: 'Aktiválva',
		...
		confirmation: 'Jól meggondoltam,',
		deleteThe: 'törlöm a ',
		alert: ' fiókot és annak minden adatát (térképek, projektek, beérkezett adatok, képek).',
		errorDelete: 'Törlés sikertelen',
		changeSuccessful: 'Módosítás sikeres',
		changeFailed: 'Módosítás sikertelen',
		uploadFailedPicture: 'Kép feltöltése sikertelen.',
	},
	users: {
		users: 'Felhasználók',
		email: 'Új felh. email címe',
		add: 'Hozzáadás',
		filter: 'Szűrés',
		notActive: 'Még nem aktivált',
