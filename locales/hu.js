export default {
	...
	aboutPartimap: {
		...
		developerTitle: 'Kik állnak a PARTIMAP mögött?',
		developerDesc: 'A PARTIMAP-ot a <a href="https://k-monitor.hu/" target="_blank" rel="noopener">K-Monitor</a> fejleszti: egy civil szervezet, amely 2007 óta küzd a közpénzek átlátható felhasználásáért és a korrupció visszaszorításáért. Valljuk, hogy az átláthatóság csak akkor válik valódi erővé, ha az állampolgárok aktívan részt vesznek a közösségi döntésekben, ezért fejlesztettük a PARTIMAP-ot, hogy a részvételi folyamatok mindenki számára hozzáférhetőbbé váljanak.',
		developerLink: 'Tudj meg többet rólunk',
		interested: 'Érdekel?',
